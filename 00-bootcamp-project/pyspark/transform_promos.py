...
GCS_FILE_PATH = "gs://deb-bootcamp-03/raw/greenery/promos/promos.csv"
...
df.createOrReplaceTempView("promos")
result = spark.sql("""
    select
        *
...
OUTPUT_PATH = "gs://deb-bootcamp-03/cleaned/greenery/promos"
